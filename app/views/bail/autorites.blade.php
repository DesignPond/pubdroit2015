	 ...
	 <div id="content" class="inner">
	     ...
	     <div class="row">
	        ...
	        <div class="large-4 columns autorite-canton">
				...
				{{HTML::image('/images/bail/canton/45fe078900.png')}}</p>
	        ...
	        <div class="large-4 columns autorite-canton">
				...
				{{HTML::image('/images/bail/canton/aeef693a70.png')}}</p>
	        ...
	        <div class="large-4 columns autorite-canton">
				...
				{{HTML::image('/images/bail/canton/0ca9bf9491.png')}}</p>
	   ...
	   <div class="row">
	        ...
	        <div class="large-4 columns autorite-canton">
				...
				{{HTML::image('/images/bail/canton/58b66c6d5e.png')}}</p>
	        ...
	        <div class="large-4 columns autorite-canton">
				...
				{{HTML::image('/images/bail/canton/dfeb018409.png')}}</p>
	        ...
	        <div class="large-4 columns autorite-canton">
				...
				{{HTML::image('/images/bail/canton/8aa7ed959b.png')}}</p>
	   ...
	   <div class="row">
	        ...
	        <div class="large-4 columns autorite-canton">
				...
				{{HTML::image('/images/bail/canton/1a3d0e3117.png')}}</p>
