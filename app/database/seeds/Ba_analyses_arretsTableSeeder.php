...
class Ba_analyses_arretsTableSeeder extends Seeder {

    public function run()
    {
      
		// Uncomment the below to wipe the table clean before populating
		DB::table('ba_analyses_arrets')->truncate();

		$ba_analyses_arrets = array(
			...
			DB::table('ba_analyses_arrets')->insert($ba_analyses_arrets);
